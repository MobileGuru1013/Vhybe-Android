...
public class OthersRecentActivityLoader extends AsyncTaskLoader<List<Post>> {
    ...
    public OthersRecentActivityLoader(Context context, ListView listViewTimeline ,int userID) {
    ...
    public List<Post> loadInBackground() {
    	...
    	ArrayList<Post> posts = sharedConnect.getRecentActivity(userID, page, 7);
        return posts;
    }
